...
def cross_entropy_loss(pred, mask, num_object, eps=1e-5, bootstrap=0.4, ref=None):
...
def mse_sim_loss(pred, true, true_mask):
    return torch.nn.functional.mse_loss(pred, true * true_mask.int())
